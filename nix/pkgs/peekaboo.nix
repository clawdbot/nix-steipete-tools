...
let
  sources = {
    "aarch64-darwin" = {
      url = "https://github.com/openclaw/Peekaboo/releases/download/v4.0.0/peekaboo-macos-universal.tar.gz";
      hash = "sha256-9UQ/OCmMK/3Xcws8/uPIrncMP6tYpGeo4Ppz9ffB3v4=";
    };
  };
in
stdenv.mkDerivation {
